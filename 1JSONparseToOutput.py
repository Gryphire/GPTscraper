...
#print('The following data files have been found: '+ str(dataFiles))
...
print('Facebook Messenger data scraped. Moving on to Twitter now.')


## TWITTER DATA

# Query user for the Twitter user name, if not provided skip the rest of the Twitter code
TwitName = input("Please enter your Twitter username and hit Enter (if you don't use Twitter, type N and hit Enter): ")
...
print('The scraping script is now done running. Smiley day to ya!')
